...
class CornersAndCapsulesProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        return total_food == 0 and total_capsules == 0
            ...
            if not hitsWall:
                if len(capsules) > 0:
                    if not hitsFood:
                        ...
                        new_capsules = copy.deepcopy(capsules)
                        if hitsCapsule:
...
def cornersAndCapsulesHeuristic(state, problem):
    """
    A heuristic for the CornersAndCapsulesProblem that you defined.

      state:   The current search state
               (a data structure you chose in your search problem)

      problem: The CornersAndCapsulesProblem instance for this layout.
